...
> Note: you need to have run [The undesired behavior](#the-undesired-behavior) steps first. Otherwise the python asset won't have run and the downstream dbt asset will fail to materialize because its "source" data is missing.
1. `cd dbt`
